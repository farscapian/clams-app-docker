...
export DEFAULT_CLN_DOCKER_BASE_IMAGE="$DEFAULT_CLN_DOCKER_BASE_IMAGE"

export REGTEST_BLOCK_TIME="$REGTEST_BLOCK_TIME"
export CHANNEL_SETUP="$CHANNEL_SETUP"
export CREATE_PRISM="$CREATE_PRISM"
...
export CLN_BASE_IMAGE_OVERRIDE="$CLN_BASE_IMAGE_OVERRIDE"
...
export LNPLAY_EXTERNAL_DOMAIN="$LNPLAY_EXTERNAL_DOMAIN"
