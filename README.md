...
|`BACKEND_FQDN`|`lnplay`|Default backend lnplay FQDN (e.g., lnplay.domain.tld|
|`FRONTEND_FQDN`|`remote`|Default frontend remote FQDN (e.g., remote.domain.tld)|
...
|`CREATE_PRISM`|`false`|By default, a prism will not be created.|
...
|`DIRECT_LINK_FRONTEND_URL_OVERRIDE_FQDN`|`null`|If specified, overrides the `https://${BACKEND_FQDN}` to specified value: e,g., 'app.clams.tech'|
